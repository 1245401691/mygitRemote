...
import cn.wolfcode.AlipayConfig;
...
public class AplipayController {
    ...
    @ResponseBody
    public void alipayTradePagePay(HttpServletResponse response, HttpServletRequest request) throws Exception {
    ...
    public void notifyUrl(HttpServletResponse response,@RequestParam Map<String,String> params) throws Exception {
        response.setContentType("text/html;charset=utf-8");
        PrintWriter out = response.getWriter();
